...
def load_loggers(cfg: Dict):
    """Return a CSV logger for the Trainer.

    Logs go to {log_path}/{model_name}/{current_time}/{expr_name}.
    """
...
def load_callbacks(cfg: Dict):
    """Build the EarlyStopping and ModelCheckpoint callbacks from cfg.CALLBACKS.

    Missing monitor/mode settings fall back to cfg.TRAINING.
    """
    ...
    if 'early_stopping' in cfg.CALLBACKS:
        ...
        # cfg sections may be plain dicts or attribute-style objects.
